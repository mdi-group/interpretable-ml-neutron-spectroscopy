...
data_path = ('/home/mts87985/ml-ins/data/pcsmo/')
ge_data_file = data_path + 'goodenough/brilla/simulate_goodenough_new.npy'
di_data_file = data_path + 'dimer/brilla/simulated_dimer_newer.npy'
