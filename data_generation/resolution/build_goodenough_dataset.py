...
debug = False
index = 6
data_dir = '/work3/isis/scarfxxx/pcsmo_goodenough/conv/'
label_dir = '/work3/isis/scarfxxx/pcsmo_goodenough/label/'

det_mask = np.load('/work3/isis/scarfxxx/pcsmo_goodenough/detector_mask.npy')
